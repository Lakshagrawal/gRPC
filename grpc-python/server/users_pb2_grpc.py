...
class UsersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserStreamReply = channel.unary_stream(
                '/users.Users/GetUserStreamReply',
                request_serializer=users__pb2.UserRequest.SerializeToString,
                response_deserializer=users__pb2.UserReply.FromString,
                _registered_method=True)
        self.GetUserBidiStream = channel.stream_stream(
                '/users.Users/GetUserBidiStream',
                request_serializer=users__pb2.UserRequest.SerializeToString,
                response_deserializer=users__pb2.UserReply.FromString,
                _registered_method=True)
...
def add_UsersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetUserStreamReply': grpc.unary_stream_rpc_method_handler(
                    servicer.GetUserStreamReply,
                    request_deserializer=users__pb2.UserRequest.FromString,
                    response_serializer=users__pb2.UserReply.SerializeToString,
            ),
...
class Users(object):
    ...
    @staticmethod
    def GetUserStreamReply(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
